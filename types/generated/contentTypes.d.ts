...
export interface ApiAvisoDePrivacidadAvisoDePrivacidad
  ...
  collectionName: 'aviso_de_privacidads';
  info: {
    displayName: 'Aviso de privacidad';
    pluralName: 'aviso-de-privacidads';
...
export interface ApiCategoriaRecetaCategoriaReceta
  extends Struct.CollectionTypeSchema {
  collectionName: 'categoria_recetas';
  info: {
    description: '';
    displayName: 'Categoria Receta';
    pluralName: 'categoria-recetas';
    singularName: 'categoria-receta';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categoria-receta.categoria-receta'
    > &
      Schema.Attribute.Private;
...
export interface ApiRecetaReceta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria_receta: Schema.Attribute.Relation<
      'manyToOne',
      'api::categoria-receta.categoria-receta'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categoria-receta.categoria-receta': ApiCategoriaRecetaCategoriaReceta;
